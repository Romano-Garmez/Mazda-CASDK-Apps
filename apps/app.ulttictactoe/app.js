...
CustomApplicationsHandler.register("app.ulttictactoe", new CustomApplication({
    ...
    require: {
        ...
        js: ['jquery.min.js', 'UnityObject2.js', 'getCWD.js'],
    ...
    created: function() {
        ...
        var htmlLocation = get_CWD() + "WebPlayerBuild.html";

        // let's build our interface
        this.iframe = $("<iframe/>", {
            src: htmlLocation,  // URL of the site you want to embed
