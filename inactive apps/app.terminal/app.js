...
*/
  ...
  helplist : function ()
  {
    var command = 'echo "Shortcut command : "'
    this.ws.send(command);
    command = 'cat /resources/aio/mzd-casdk/apps/app.terminal/cmd.txt';
    this.ws.send(command);
  },
    ...
    switch (char) {
      case  "return":
        ...
        switch (this.command) 
        {
          ...
          case "ia":
            this.command = "opkg install headunit";
          ...
          case "ra":
            this.command = "opkg remove headunit";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
          ...
          case "iv":
            this.command = "opkg install mzd-videoplayer-vic";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
            break;
          case "rv":
            this.command = "opkg remove mzd-videoplayer-vic";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
          ...
          case "i1":
            this.command = "opkg install casdk-gpsspeed";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
            break;
          case "r1":
            this.command = "opkg remove casdk-gpsspeed";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
          ...
          case "i2":
            this.command = "opkg install casdk-multidash";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
          ...
          case "i5":
            this.command = "opkg install casdk-vdd";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
            break;
          case "r5":
            this.command = "opkg remove casdk-vdd";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
          ...
          case "i11":
            this.command = "opkg install mzd-aiotweaks";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
            break;
          case "r11":
            this.command = "opkg remove mzd-aiotweaks";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
          ...
          case "i12":
            this.command = "opkg install mzd-background-rotator";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
            break;
          case "r12":
            this.command = "opkg remove mzd-background-rotator";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
          ...
          case "i13":
            this.command = "opkg install mzd-cschatthai-font";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
          ...
          case "r13":
            this.command = "opkg remove mzd-cschatthai-font";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
          ...
          case "i14":
            this.command = "opkg install mzd-v59patch";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
          ...
          case "r14":
            this.command = "opkg remove mzd-v59patch";
            this.AddText(">" + this.command);
            this.ws.send(this.command);
            this.command = "";
            this.update();
